                ...
                {currentPageData.map((row) => (
                  <tr
                    ...
                    className={`cursor-pointer ${
                      row.carID === selectedRow
                        ? 'border-4 border-black rounded bg-sky-200'
                        : currentPageData.indexOf(row) % 2 === 0
                        ? 'bg-gray-100'
                        : 'bg-gray-200'
                    }`}
          ...
          <div className="bg-white p-6 rounded shadow-md">
            ...
            <div className="flex justify-end space-x-4">
              <button
                ...
                className="border border-black rounded px-4 py-2 bg-gray-500 text-white rounded"
              >
              ...
              <button
                ...
                className="border border-black rounded px-4 py-2 bg-red-500 text-white rounded"
              >
                <FontAwesomeIcon icon={faTrashCan} className="pr-2" />
                {t('delete')}
              </button>
